...
#
	my ($authors, $title, $subtitle, $journalTitle, $enum1, $enum2, $chron2, $chron1, $startPage, $endPage, $pageList, $issn, $columnTitle, $type, $partNumber, $partName, $url ,$doi, $setText) = @$row;
